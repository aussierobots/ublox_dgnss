...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_VELNED_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_VELNED_HPP
...
namespace ubx {
  namespace nav::velned {
   ...
   class NavVelNEDPayload : UBXPayload {
      ...
      public:
      NavVelNEDPayload() : UBXPayload(MSG_CLASS,MSG_ID) {}
      NavVelNEDPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS,MSG_ID) {
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_VELNED_HPP