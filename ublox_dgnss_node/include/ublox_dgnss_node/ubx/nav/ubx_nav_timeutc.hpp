...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_TIMEUTC_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_TIMEUTC_HPP
...
namespace ubx {
  namespace nav::timeutc {
    ...
    class NavTimeUTCPayload : UBXPayload {
      ...
      const static msg_id_t MSG_ID = UBX_NAV_TIMEUTC;
      ...
      public:
      NavTimeUTCPayload() : UBXPayload(MSG_CLASS,MSG_ID) {}
      NavTimeUTCPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS,MSG_ID) {
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_TIMEUTC_HPP