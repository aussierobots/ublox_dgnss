...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_HPPOSLLH_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_HPPOSLLH_HPP
...
namespace ubx {
  namespace nav::hpposllh {
    ...
    class NavHPPosLLHPayload : UBXPayload {
      ...
      const static msg_id_t MSG_ID = UBX_NAV_HPPOSLLH;
      ...
      public:
      NavHPPosLLHPayload() : UBXPayload(MSG_CLASS,MSG_ID) {}
      NavHPPosLLHPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS,MSG_ID) {
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_HPPOSLLH_HPP