...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_HPPOSECEF_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_HPPOSECEF_HPP
...
namespace ubx {
  namespace nav::hpposecef {
    ...
    class NavHPPosECEFPayload : UBXPayload {
      ...
      const static msg_id_t MSG_ID = UBX_NAV_HPPOSECEF;
      ...
      public:
      NavHPPosECEFPayload() : UBXPayload(MSG_CLASS,MSG_ID) {}
      NavHPPosECEFPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS,MSG_ID) {
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_HPPOSECEF_HPP