...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_DOP_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_DOP_HPP
...
namespace ubx {
  namespace nav::dop {
    class NavDOPPayload : UBXPayload {
      ...
      const static msg_id_t MSG_ID = UBX_NAV_DOP;
      ...
      public:
      NavDOPPayload() : UBXPayload(MSG_CLASS,MSG_ID) {}
      NavDOPPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS,MSG_ID) {
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_DOP_HPP