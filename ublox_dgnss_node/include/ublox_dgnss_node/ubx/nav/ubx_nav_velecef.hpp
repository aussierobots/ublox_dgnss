...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_VELECEF_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_VELECEF_HPP
...
namespace ubx {
  namespace nav::velecef {
   ...
   class NavVelECEFPayload : UBXPayload {
      ...
      public:
      NavVelECEFPayload() : UBXPayload(MSG_CLASS,MSG_ID) {}
      NavVelECEFPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS,MSG_ID) {
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_VELECEF_HPP