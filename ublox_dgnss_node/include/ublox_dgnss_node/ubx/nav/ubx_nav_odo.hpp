...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_ODO_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_ODO_HPP
...
namespace ubx {
  namespace nav::odo {
   ...
   class NavOdoPayload : UBXPayload {
      ...
      const static msg_id_t MSG_ID = UBX_NAV_ODO;
      ...
      public:
      NavOdoPayload() : UBXPayload(MSG_CLASS,MSG_ID) {}
      NavOdoPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS,MSG_ID) {
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_ODO_HPP