...
#ifndef UBLOX_DGNSS_NODE__UBX_NAV_POSLLH_HPP
#define UBLOX_DGNSS_NODE__UBX_NAV_POSLLH HPP
...
namespace ubx {
  namespace nav::posllh {
    ...
    class NavPosLLHPayload : UBXPayload {
      ...
      public:
      NavPosLLHPayload(): UBXPayload(MSG_CLASS, MSG_ID)  {}
      NavPosLLHPayload(ch_t* payload_polled, u2_t size) : UBXPayload(MSG_CLASS, MSG_ID){
        payload_.clear();
...
#endif // UBLOX_DGNSS_NODE__UBX_NAV_POSLLH HPP