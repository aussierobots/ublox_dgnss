...
// cfg sec
const ubx_cfg_item_t CFG_SEC_SPOOFDET_SIM_SIG_DIS = {"CFG_SEC_SPOOFDET_SIM_SIG_DIS", 0x10f6005d, L, 1, NA};
const ubx_cfg_item_t CFG_SEC_JAMDET_SENSITIVITY_HI = {"CFG_SEC_JAMDET_SENSITIVITY_HI", 0x10f60051, L, 1, NA};
