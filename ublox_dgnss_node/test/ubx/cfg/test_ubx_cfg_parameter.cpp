...
TEST_F(UbxCfgParameterTest, BehaviorChanges)
{
  ...
  EXPECT_EQ(parameter_->get_behavior_change("ZED-F9P", "HPG 1.32"), "Improved handling and performance");  // Change in this version
  EXPECT_EQ(parameter_->get_behavior_change("ZED-F9P", "HPG 1.33"), "Improved handling and performance");  // Change applies to later versions too
